...
class Search extends Component {
  render() {
    ...
    return (
      <div className={this.styles.mainDiv}>
  ...
  get styles() {
    return {
      mainDiv: 'absolute h42 w-full w420-mm bg-white shadow-darken25 flex-parent flex-parent--row flex-parent--space-between-main searchDiv',
